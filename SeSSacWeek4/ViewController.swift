...
class ViewController: UIViewController {
    ...
    func callRequest(date: String) {
        ...
        let url = "https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=\(APIKey.koficKey)&targetDt=\(date)"
...
extension ViewController: UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        //20220101 -> 1. 8글자, 2. 올바른 날짜 3. 날짜 범주(api가 제공하는)
